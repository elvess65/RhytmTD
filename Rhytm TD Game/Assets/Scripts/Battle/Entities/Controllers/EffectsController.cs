...
namespace RhytmTD.Battle.Entities.Controllers
{
    public class EffectsController : BaseController
    {
        ...
        public BattleEntity CreateBulletEffect(EnumsCollection.BattleEntityEffectID typeID, Vector3 position, Quaternion rotation, float speed, BattleEntity owner)
        {
