...
{
    internal class CurvedStandardParticlesShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent curvature = EditorGUIUtility.TrTextContent("Curvature");
            public static GUIContent cameraOffset = EditorGUIUtility.TrTextContent("Camera Offset");
        }
        ...
        MaterialProperty cameraOffset = null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            cameraOffset = FindProperty("_CameraOffset", props);
        }
